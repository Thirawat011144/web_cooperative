    ...
    <div class="card">
      <div class="card-header">
        <div class="card-title mb-2">
          ข้อมูลนักศึกษาชั้นประกาศนียบัตรวิชาชีพ ชั้นปีที่ 3 (อนุมัติ)
          <div>
            ...
            <tr v-for="(user, index) in sortedUsers" :key="user.id">
              ...
              <td class="text-center">
                <button
                  ...
                  @click="showModal(user.id, evaluationdata)"
                >
                  ดูข้อมูล
                </button>
              </td>
              <td>
                <button
                  ...
                  @click="handleStatus(user.id, 'เข้ารับการฝึก')"
                >
                  เข้ารับการฝึก
                </button>
